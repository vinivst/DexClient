...
function App({ web3, accounts, contracts }) {
  ...
  const faucet = async (token, trader, amount) => {
    console.log(token);
    console.log(contracts);
    console.log(contracts[token.ticker]);
    console.log(trader);
    console.log(amount);
    await contracts[token.ticker].methods
      .faucet(trader, amount)
      ...
      <main className="container-fluid">
        <div className="row">
          <div className="col-sm-4 first-col">
            ...
            <Faucet user={user} faucet={faucet} />
          </div>
          {user.selectedToken.ticker !== 'DAI' ? (
